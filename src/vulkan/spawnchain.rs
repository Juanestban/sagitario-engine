...
use vulkanalia::{
  vk::{self, DeviceV1_0, HasBuilder, KhrSurfaceExtension, KhrSwapchainExtension},
  Device, Instance,
};
...
pub unsafe fn create_swapchain_image_views(device: &Device, data: &mut VulkanAppData) -> Result<()> {
